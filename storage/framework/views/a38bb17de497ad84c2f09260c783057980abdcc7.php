...
<head>
    ...
    <style>
        body {
            background-image:url('<?php echo e(Voyager::image( Voyager::setting("admin.bg_image"), voyager_asset("images/Bg.png") )); ?>');
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <!--<div class="logo-title-container">
                        ...
                        <?php if($admin_logo_img == ''): ?>
                            <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="<?php echo e(voyager_asset('images/picksureLogo.png')); ?>" alt="Logo Icon" style="max-width:250px">
                        <?php else: ?>
...
<?php /**PATH /home/u395993619/domains/picksure.tech/public_html/vendor/tcg/voyager/src/../resources/views/auth/master.blade.php ENDPATH**/ ?>