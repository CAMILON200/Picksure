...
class PautasUsersController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
	...
	public function show(Request $request, $id)
	{
			...
			$categories = DB::table('categories_pautas')
			->join('categories', 'categories.id', '=', 'categories_pautas.category_id')
			->join('texts_categories', 'texts_categories.category_id', '=', 'categories.id')
			->select('texts_categories.name')
			->where('categories_pautas.pauta_id', '=', $id)
			->where('texts_categories.language', '=', 'ES')
			->get();
			
			$locations = DB::table('locations_pautas')
			->join('locations', 'locations.code_iso', '=', 'locations_pautas.location_prefix')
			->select('locations.name')
			->where('locations_pautas.pauta_id', '=', $id)
			->get();
			...
			return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'categories', 'locations', 'images_pautas'));
	}
