                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-heading" style="border-bottom:0;">
                            <h6 class="panel-title" style="background: #f8fafc;">{{ $row->getTranslatedAttribute('display_name') }}</h6>
                        </div>
            ...
            <div class="col-md-8">
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th scope="col" style="font-size: 18px">Nombre Categoria</th>
                                <th scope="col" style="font-size: 18px">Idiomas</th>
                            </tr>
                        </thead>
                        <tbody id="columnItemText">
                            @foreach($textCategories as $key => $value)
